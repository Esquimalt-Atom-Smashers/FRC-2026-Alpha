...
// import frc.robot.subsystems.CommandSwerveDrivetrain; // Commented out for AdvantageKit
...
public class TunerConstants {
  ...
  private static final Slot0Configs driveGains = // TODO: Tune driving vals
      new Slot0Configs().withKP(0.2).withKI(0).withKD(0.01)
        .withKS(0.12).withKV(0.85).withKA(0.2);
  ...
  private static final TalonFXConfiguration steerInitialConfigs =
    ...
    private static final Angle kFrontLeftEncoderOffset = Rotations.of(0.10791015625);
